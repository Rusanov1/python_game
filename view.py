...
class Actor(pygame.sprite.Sprite):
    ...
    normal_actor = pygame.image.load("normal_cat.png")
    sad_actor = pygame.image.load("sad_cat.jpg")

    play_actor = pygame.image.load("play_cat.jpg")
    feed_actor = pygame.image.load("eat_cat.webp")
    sleep_actor = pygame.image.load("sleep_cat.png")
    ...
    def __init__(self, pos_x, pos_y):
        ...
        self.tirednes_progress_bar = ProgressBar(self.progress_bar_width, self.progress_bar_height,
    ...
    def sleep(self):
        self.tiredness = self.max_char_value 
        self.tirednes_progress_bar.update(self.tiredness)
        if self.is_sleeping == True:
            self.is_sleeping = False
            self.image = self.normal_actor
        else:
...
class Cursor(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("cursor_new.png")
        self.rect = self.image.get_rect()
    def update(self):
